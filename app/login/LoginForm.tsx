      ...
      <div className="flex min-h-screen flex-col items-center justify-center md:flex-row">
        ...
        <div className="hidden w-full max-w-md flex-col justify-center space-y-6 p-8 md:flex md:p-10 lg:p-12">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">Login to your account to continue your resume optimization journey</p>
          </div>

          <Separator className="my-4" />

          <div className="space-y-8">
            <h2 className="text-xl font-semibold">Do you know ?</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  <h3 className="font-medium">First Impressions Matter</h3>
                  <p className="text-sm text-muted-foreground">
                    Recruiters spend an average of just 6-7 seconds reviewing a resume before deciding whether to
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Over 75% of resumes are rejected by ATS (Applicant Tracking Systems) before a human ever sees them.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Resumes with quantifiable achievements are 40% more likely to get an interview than those with
